...
def main(self):
         ...
         data = urllib.request.urlopen("https://img.icons8.com/cute-clipart/64/000000/task.png").read()
         image = QPixmap()
         ...
         def SetWhiteMode():
             ...
             self.setStyleSheet("font-family: Tahoma, Verdana;")
             logininput.setStyleSheet("font-size: 25px; font-family: Tahoma, Verdana;")
             passwordinput.setStyleSheet("font-size: 25px; font-family: Tahoma, Verdana;")
             Login.setStyleSheet("font-size: 55px; font-family: Tahoma, Verdana;")
             ChangePasswordinsign.setStyleSheet("font-size: 55px; font-family: Tahoma, Verdana;")
         ...
         def changelanguage(language):
             ...
             self.languagepack =languagepacks[languageindex]
             logininput.setPlaceholderText(self.languagepack[2],)
             passwordinput.setPlaceholderText(self.languagepack[3],)
             Login.setText(self.languagepack[0])
             ChangePasswordinsign.setText(self.languagepack[27])
             Settingsinsign.setText(self.languagepack[28])
             Loginbutton.setText(self.languagepack[1])
             Fromregisterreturnbutton.setText(self.languagepack[4])
             Registerbutton.setText(self.languagepack[5])
             CreateNotebutton.setText(self.languagepack[6])
             ExtindedRegisterbutton.setText(self.languagepack[5])
             SaveNotebutton.setText(self.languagepack[7])
             UpdateNotebutton.setText(self.languagepack[8])
             Returnbutton.setText(self.languagepack[4])
             DeleteNotebutton.setText(self.languagepack[9])
             Deleteaccauntbutton.setText(self.languagepack[17])
             SecondReturnbutton.setText(self.languagepack[4])
             Changepasswordbutton.setText(self.languagepack[18])
             Returntologinbutton.setText(self.languagepack[19])
             ChangePasswordinput.setPlaceholderText(self.languagepack[22],)
             SecondChangePasswordinput.setPlaceholderText(self.languagepack[23],)
             SaveNewPasswordButton.setText(self.languagepack[20])
             CreateUserbutton.setText(self.languagepack[21])
             SearchNoteinp.setPlaceholderText(self.languagepack[24])
             Deletealldatabutton.setText(self.languagepack[32])
             Regl.setText(self.languagepack[5])
             tlde.setText(self.languagepack[10])
             ipw.setText(self.languagepack[11])
             aep.setText(self.languagepack[12])
             tsp.setText(self.languagepack[13])
             languageinsign.setText(self.languagepack[25])
             nighttheme.setText(self.languagepack[26])
             logincantbeadminerror.setText(self.languagepack[29])
             itsnotthesamepassword.setText(self.languagepack[30]) 
             tooshortlogin.setText(self.languagepack[31])
             fileMenu = mainMenu.addMenu(self.languagepack[33])
             settingsaction.setText(self.languagepack[16])
             changeuseraction.setText(self.languagepack[4])
             updatenoteaction.setText(self.languagepack[8])
             deletenoteaction.setText(self.languagepack[9])
             savenoteaction.setText(self.languagepack[7])
             exitaction.setText(self.languagepack[35])
             deleteuseraction.setText(self.languagepack[17])
             changepasswordaction.setText(self.languagepack[27])
             deletealldataaction.setText(self.languagepack[32])
             createnewuseraction.setText(self.languagepack[21])
             createnoteaction.setText(self.languagepack[6])
             if languageindex == 0:
               Loginbutton.setStyleSheet("font-size: 12px; font-family: Tahoma, Verdana; background-color:#66c2ff")
               CreateUserbutton.setStyleSheet("font-size: 14px; font-family: Tahoma, Verdana;")
               Regl.move(130, 105)
         ...
         def info():
            reply = QMessageBox()
            reply.setText('Version: 1.7\n\nCreator: Motricala Alan\nContact: motricala44@gmail.com' )
            reply.exec()
         ...
         helpaction.triggered.connect(info)
